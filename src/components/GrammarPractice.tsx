...
export default function GrammarPractice({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-4">
      ...
      <div className="bg-white p-1.5 sm:p-2 rounded-2xl grid grid-cols-2 lg:flex lg:flex-row gap-1.5 sm:gap-2 mb-6 sm:mb-8 border-4 border-slate-900 shadow-[4px_4px_0px_0px_#0f172a]">
        {subTabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`lg:flex-1 py-2 sm:py-3 px-2 sm:px-4 rounded-xl text-[10px] sm:text-xs font-black uppercase tracking-tight transition-all text-center cursor-pointer ${
                isSelected 
